...
props.put("mail.smtp.port", "587");//ASSIGN A PORT THROUGH WHICH ALL WORKING IS //DONE....
 ...
 //THIS WILL READ THE ADDRESSES ONE BY ONE WHICH ARE SPECIFIED TO SEND MAIL....
    ...
    message.setSubject("Verify Mail To Register");
    message.setText(otp);
...
RequestDispatcher dp=request.getRequestDispatcher("confirmotp.jsp?k="+otp+"&k1="+toa+"&k2="+a+"&k3="+b+"&k5="+d+"&k6="+e+"&k7="+f+"");//IF MAILING IS COMPLETED //SUCCESSFULLUL THEN THIS JSP PAGE WILL BE OPENED....
